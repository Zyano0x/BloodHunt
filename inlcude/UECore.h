...
#define FNAME_POOL
#define MODULE_NAME skCrypt(L"Tiger-Win64-Shipping.exe")
#define OBJECTS_OFFSET 0x05BF1AC8
#define NAMES_OFFSET 0x05BD92C0
#define WORLD_OFFSET 0x05D209C0
#define PROCESS_EVENT_INDEX 0x43
#define PROCESS_EVENT_OFFSET 0x0197E150
...
public:
    ...
    unsigned char UnknownData_3RBX[0x10]; // 0x0008(0x0010) MISSED OFFSET (PADDING)
...
public:
    ...
    inline FKey(const FName InName)
        : KeyName(InName)
        , UnknownData_3RBX {}
    {
    }

    inline FKey(const char* InName)
        : KeyName(FName(InName))
        , UnknownData_3RBX {}
    {
    }

    inline FKey(const TCHAR* InName)
        : KeyName(FName(InName))
        , UnknownData_3RBX {}
    {
    }
